...
\title{Методи на Ойлер и Лагранж и теорема на Лайбниц. Интегрална форма на закона за запазване на масата. Уравнение на непрекъснатостта в
променливи на Ойлер.}
\author{Васил Иванов}
\date{\today}
